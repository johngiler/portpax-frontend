...
const FIELD_LABELS: Record<string, string> = {
  ...
  shipping_line_group_id: "Grupo de naviera",
  shipping_line_group_code: "Grupo de naviera",
  shipping_line_group_name: "Grupo de naviera",
  tag_id: "Tag",
...
function formatValue(value: unknown, key?: string): string {
  if (key === "source" && typeof value === "string") {
    const labels: Record<string, string> = {
      ...
      booking_update: "Detalle de reserva",
      historical_tag_assign: "Asignación de tag",
      tag_rename: "Renombre de tag",
