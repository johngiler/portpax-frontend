...
import BerthFormModal from "@/components/admin/BerthFormModal";
        ...
        <AdminTable>
          <table className="w-full min-w-[theme(spacing.96)]">
            <AdminTableHeader>
              ...
              <AdminTableTh>Cap. PAX</AdminTableTh>
            ...
            <AdminTableBody>
              {filteredList.length === 0 ? (
                ...
                <AdminTableRow key={b.id}>
                  ...
                  <AdminTableTd>{b.port_name}</AdminTableTd>
                  <AdminTableTd className="tabular-nums">{b.capacity_pax ?? "—"}</AdminTableTd>
                  <AdminTableTd>
                    <TableActionButtons
                      onView={() => openEdit(b)}
                      onEdit={() => openEdit(b)}
