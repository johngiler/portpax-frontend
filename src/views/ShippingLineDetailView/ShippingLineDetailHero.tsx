...
import { ArrowLeft, Anchor, Pencil, Ship, Trash2 } from "lucide-react";
...
type ShippingLineDetailHeroProps = {
...
export default function ShippingLineDetailHero({
  line,
  onEdit,
  onDelete,
  canWrite = true,
                ...
                <div className="flex min-w-0 items-stretch gap-3 sm:gap-4">
                  ...
                  <div ref={textExpandedRef} className="min-w-0 flex flex-col">
                    <div ref={textCoreRef}>
                      <p
                        className={[
                          "font-semibold uppercase text-[var(--admin-accent)]",
                      ...
                      <div className={isStuck ? "mt-1 flex flex-wrap gap-1.5" : "mt-2 flex flex-wrap gap-2"}>
                        ...
                        <span
                          className={[
                            "rounded-full bg-zinc-100 font-mono font-medium text-zinc-600 dark:bg-zinc-800 dark:text-zinc-300",
                            isStuck ? "px-2 py-0.5 text-[10px]" : "px-2.5 py-0.5 text-xs",
                          ].join(" ")}
                        >
                          {line.code}
                      ...
                      {!isStuck && (
                        ...
                        >
                          ...
                          <span>
                            ...
                            {line.vessel_count > 0
                              ? `${line.vessel_count} barco${line.vessel_count === 1 ? "" : "s"} en catálogo`
                              : "Sin barcos registrados"}
                          </span>
                        </motion.p>
                      )}
                    </AnimatePresence>
