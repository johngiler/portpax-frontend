...
export default function PositionFormModal({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const payload: PositionPayload = {
      ...
      bollard_allocations:
        form.position_type === "anchorage" ? [] : bollardAllocations,
      fender_allocations:
        form.position_type === "anchorage" ? [] : fenderAllocations,
      min_loa_m: null,
    };
        ...
        <div className="grid gap-5 lg:grid-cols-[minmax(220px,260px)_1fr]">
          ...
          <div className="space-y-4">
            <FormSection
              ...
              description="Puerto, código y asignación de muelle."
            >
              {!lockedPortId && (
            ...
            >
              ...
              {form.position_type !== "anchorage" && form.port > 0 && (
